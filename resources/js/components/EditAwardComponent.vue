  ...
  <div>
    <div class="wt-accordioninnertitle">
      ...
      >
        ...
        <h3>
          {{this.stored_award_title}}
          <span>{{this.stored_award_date}}</span>
        </h3>
      </div>
    ...
    >
      <fieldset>
        <div class="form-group form-group-half">
          <input
            type="text"
            :value="this.stored_award_title"
            v-bind:name="this.award_title_name"
            class="form-control"
