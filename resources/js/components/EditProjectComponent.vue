<template>
  <div>
    <div class="wt-accordioninnertitle">
      <div
        v-if="this.stored_project_img"
        :id="this.main_accordion_id"
        class="wt-projecttitle collapsed"
        data-toggle="collapse"
        :data-target="'#'+this.inner_accordion_id"
      >
        ...
        <h3>
          {{this.stored_project_title}}
          <span>{{this.stored_project_url}}</span>
        </h3>
      </div>
      <div
        v-else
      ...
      <div class="wt-rightarea">
        ...
        <a href="javascript:void(0);" class="wt-deleteinfo" @click="removeElement()">
    ...
    <div
      ...
      :id="this.inner_accordion_id"
      :aria-labelledby="this.main_accordion_id"
    ...
    >
      <fieldset>
        <div class="form-group form-group-half">
          <input
            type="text"
            :value="this.stored_project_title"
            v-bind:name="this.project_title_name"
            class="form-control"
            :placeholder="this.project_title"
          />
        </div>
        <div class="form-group form-group-half">
          <input
            type="text"
            :value="this.stored_project_url"
            v-bind:name="this.project_url_name"
            class="form-control"
            :placeholder="this.project_url"
          />
        </div>
            ...
            <li>
              ...
              <em>
                <a
                  class="dz-remove"
                  href="javascript:;"
                  @click="removeImage(img_hidden_id)"
                  :id="this.uploaded_image_remove_id"
                >
                  <span class="lnr lnr-cross"></span>
                </a>
              </em>
              <input
                type="hidden"
                v-bind:name="this.img_hidden_name"
                :id="this.img_hidden_id"
                :value="this.stored_image_name"
              />
            </li>
          </ul>
        </div>
...
export default {
  props: [
    ...
    "main_accordion_id",
    "inner_accordion_id",
    "stored_project_title",
    "stored_project_url",
    "stored_project_img",
    "project_title_name",
    "project_url_name",
    "previewer_class",
    "remove_uploded_image_id",
    "uploaded_image_remove_id",
    "project_title",
    "project_url"
  ],
  components: {
        ...
        init: function() {
          ...
          this.on("addedfile", function(file) {
            var input_hidden_id = jQuery("#" + myDropzone.element.id)
              .parents(".project-inner-list-item")
              .find("fieldset input[type=hidden]")
              .attr("id");
