...
$page_id='';
if (!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/' && Route::getCurrentRoute()->uri() !=
'home') {
                    ...
                    <div class="wt-rightarea">
                        ...
                        <div class="wt-userlogedin">
                            <figure class="wt-userimg">
                                ...
                                --}}
                                <img src="{{{ asset(Helper::getImage('uploads/users/' . Auth::user()->id, $profile->avater, '' , 'user.jpg')) }}}"
