        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <strong class="wt-logo"><a href="{{{ url('/') }}}"><img src="{{{ asset($logo) }}}"
                                alt="{{{ trans('Logo') }}}"></a></strong>
                    @endif
                    @if (!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/' &&
                    Route::getCurrentRoute()->uri() != 'home')
                    <search-form :placeholder="'{{ trans('lang.looking_for') }}'"
                    ...
                    <div class="wt-rightarea">
                        <nav id="wt-nav" class="wt-nav navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse wt-navigation" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    $show_page = \App\SiteManagement::where('meta_key',
                                    'show-page-'.$page->id)->select('meta_value')->pluck('meta_value')->first();
                                    @endphp
                                    ...
                                    <li>
                                        <a href="{{url('search-results?type=job')}}" @if(Auth::check())
                                            @if(App\User::getUserRoleType(Auth::user()->id)->role_type == 'freelancer')
                                            style=" border-radius:10px; background-color: #f89a1c; color :
                                            white;padding-right: 20px;padding-left: 20px;"@endif @endif>
                                    ...
                                    <li>
                                        <a href="{{ route('employerPostJob') }}"
                                            style=" border-radius:10px; background-color: #f89a1c; color : white;padding-right: 20px;padding-left: 20px;">
                                            {{ 'Publier un projet' }}
                                        </a>
                                    </li>
                                    @endif
                        ...
                        <div class="wt-loginarea">
                            <div class="wt-loginoption">
                                <a href="javascript:void(0);" id="wt-loginbtn"
                                    class="wt-loginbtn">{{{trans('lang.login') }}}</a>
                                <div class="wt-loginformhold" @if ($errors->has('email') || $errors->has('password'))
                                    ...
                                    <form method="POST" action="{{ route('login') }}"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="wt-logininfo">
                                                <button type="submit"
                                                    class="wt-btn do-login-button">{{{ trans('lang.login') }}}</button>
                                        ...
                                        <div class="wt-loginfooterinfo">
                                            ...
                                            <a href="{{ route('password.request') }}"
                                                class="wt-forgot-password">{{{ trans('lang.forget_pass') }}}</a>
                                            @endif
                        ...
                        $profile_image = !empty($user_image) ? '/uploads/users/'.$user->id.'/'.$user_image :
                        ...
                        $employer_payment_module = !empty($payment_settings) &&
                        !empty($payment_settings[0]['employer_package']) ? $payment_settings[0]['employer_package'] :
                        'true';
                        @endphp
                        ...
                        @if (!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/' &&
                        Route::getCurrentRoute()->uri() != 'home')
                        <div class="wt-respsonsive-search"><a href="javascript:;" class="wt-searchbtn"><i
