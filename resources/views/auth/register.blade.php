...
<div class="wt-haslayout wt-innerbannerholder"
    style="background-image:url({{{ asset(Helper::getBannerImage('uploads/settings/home/'.$reg_form_banner)) }}})">
    <div class="container">
                ...
                <div class="wt-registerformhold">
                    <div class="wt-registerformmain">
                            ...
                            <form method="POST" action="{{{ url('register/form-step1-custom-errors') }}}"
                                    ...
                                    <div class="wt-haslayout" v-if="step === 1" v-cloak>
                                        ...
                                        <div class="form-group form-group-half">
                                            <input id="user_email" type="email" class="form-control" name="email"
                                                placeholder="{{{ trans('lang.ph_email') }}}" value="{{ old('email') }}"
                                ...
                                <div class="form-group form-group-half">
                                    <input id="password" type="password" class="form-control" name="password"
                                        placeholder="{{{ trans('lang.ph_pass') }}}"
                                ...
                                <div class="form-group form-group-half">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" placeholder="{{{ trans('lang.ph_retry_pass') }}}"
                                ...
                                <fieldset class="wt-formregisterstart">
                                    ...
                                    <ul class="wt-accordionhold wt-formaccordionhold accordion">
                                        ...
                                        <li>
                                            <div class="wt-accordiontitle" id="headingOne" data-toggle="collapse"
                                            ...
                                            <!--
                                                                    <div class="wt-accordiondetails collapse" id="" aria-labelledby="headingOne" >
                                    ...
                                    <div class="wt-checkboxholder">
                                        <span class="wt-checkbox">
                                            <input id="termsconditions" type="checkbox" name="termsconditions"
                                                checked="">
                                            <label for="termsconditions"><span>Acceptez Nos <a
                                                        href="https://writup.net/page/conditions-generales-de-vente">
                                                        Termes et Conditions.</a></span></label>
                        ...
                        <div class="wt-joinformc" v-if="step === 3" v-cloak>
                            <form method="POST" action="" class="wt-formtheme wt-formregister" id="verification_form">
                                ...
                                <figure class="wt-joinformsimg">
                                    <img src="{{ asset($register_image)}}"
                                        alt="{{{ trans('lang.verification_code_img') }}}">
                                </figure>
                                <fieldset>
                                    <div class="form-group">
                                        <label>
                                    ...
                                    <div class="form-group wt-btnarea">
                                        <a href="#" @click.prevent="verifyCode()"
                                            class="wt-btn">{{{ trans('lang.continue') }}}</a>
                                    </div>
                                </fieldset>
                            </form>
                        ...
                        <div class="wt-gotodashboard" v-if="step === 4" v-cloak>
                            <ul class="wt-joinsteps">
                                <li class="wt-done-next"><a href="javascrip:void(0);"><i class="fa fa-check"></i></a>
                                </li>
                                <li class="wt-done-next"><a href="javascrip:void(0);"><i class="fa fa-check"></i></a>
                                </li>
                                <li class="wt-done-next"><a href="javascrip:void(0);"><i class="fa fa-check"></i></a>
