...
<div class="wt-haslayout wt-innerbannerholder"
    style="background-image:url({{{ asset(Helper::getBannerImage('uploads/settings/general/'.$article_inner_banner)) }}})">
    <div class="container">
                ...
                <div class="wt-articlesingle-holder wt-bgwhite">
                    <div class="wt-articlesingle-content">
                        <figure class="wt-singleimg-one">
                            <img src="{{{asset(Helper::getImage('uploads/articles', $article->banner, 'large-', 'large-default-article.png'))}}}"
                                alt="{{{ $article->title }}}">
                        </figure>
                        <div class="wt-title">
                            <h2>{{$article->title}}</h2>
