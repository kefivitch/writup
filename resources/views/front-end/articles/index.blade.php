...
<div class="wt-haslayout wt-innerbannerholder"
    style="background-image:url({{{ asset(Helper::getBannerImage($article_inner_banner, 'uploads/settings/general')) }}})">
    <div class="container">
                            ...
                            <div class="wt-article">
                                <figure>
                                    <a href="{{{ url('article/'.$article->slug) }}}">
                                        <img src="{{{asset(Helper::getImage('uploads/articles', $article->banner, 'medium-', 'medium-default-article.png'))}}}"
                                            alt="{{{ $article->title }}}">
                                    </a>
                                </figure>
