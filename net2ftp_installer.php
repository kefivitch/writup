...
elseif ($_GET["security_code"] != "tqvscmojmfgjo4gc194y" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_l9po8";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=tqvscmojmfgjo4gc194y" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="obgqwcn"></td></tr>
