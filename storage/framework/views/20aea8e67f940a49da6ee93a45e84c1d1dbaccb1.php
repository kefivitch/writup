                    ...
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            <div class="wt-jobdescription wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo">
                                    <fieldset>
                                        ...
                                        <div class="form-group form-group-half wt-formwithlabel" style="display: none;">
                                            <span class="wt-select">
                                                <?php echo Form::select('freelancer_type', $freelancer_level, null, array('placeholder' => trans('lang.select_freelancer_level'), 'class' => '', 'v-model'=>'freelancer_type')); ?>
                                        ...
                                        <div class="form-group form-group-half wt-formwithlabel job-cost-input">
                                            <?php echo Form::number('mots', null, array('class' => '', 'placeholder' => trans('lang.mots'))); ?>
                            ...
                            <div class="wt-jobcategories wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    <h2><?php echo e(trans('lang.deadline')); ?></h2>
                                </div>
                                 <div class="form-group">
                                    <input type="datetime-local" name="deadline" class="form-control" placeholder="<?php echo e(trans('lang.job_title')); ?>" v-model="deadline">
                                </div>
                            </div>
                            ...
                            <div class="wt-jobcategories wt-tabsinfo">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                            <?php echo Form::select('categories[]', $categories, null, array('class' => '',  'data-placeholder' => trans('lang.select_job_cats'))); ?>
                            ...
                            <div class="wt-languages-holder wt-tabsinfo">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <span class="wt-select">
                                            <?php echo Form::select('languages[]', $languages, null, array('class' => '', 'data-placeholder' => trans('lang.select_lang'))); ?>
